        ...
        {isLoading ? (
          ...
          <div className="space-y-2">
            {sites.map(({ origin, data }) => (
              <div
                key={origin}
                className="flex items-center gap-3 p-3 bg-white/6 rounded-2xl"
              >
                {/* Favicon */}
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-[#ffe2cc] truncate">
                ...
                <button
                  ...
                  className="p-2 rounded-xl text-neutral-400 hover:text-red-400 hover:bg-red-900/10 transition-colors disabled:opacity-50 shrink-0"
                  title="Disconnect"
                >
